            ...
            <template #tag="{ option, remove }">
              <app-badge class="inline-flex items-center">
                ...
                <button
                  type="button"
                  @click.stop="remove"
                  class="shrink-0 ml-0.5 -mr-1 h-4 w-4 rounded-full inline-flex items-center justify-center focus:outline-none hover:bg-primary-200 focus:bg-primary-500 focus:text-white">
