...
class UpdateSubscriptionRequest extends FormRequest
{
    public function rules()
    {
        return [
            ...
            'payment_method.cc_expiration'      => ['required_if:payment_method.type,'. PaymentMethod::TYPE_CREDIT_CARD, 'date'],
            'payment_method.name_on_card'       => ['required_if:payment_method.type,'. PaymentMethod::TYPE_CREDIT_CARD, 'string'],
        ];
    }
