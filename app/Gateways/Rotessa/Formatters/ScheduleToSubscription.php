...
class ScheduleToSubscription implements Formatter
{
    public function formatOutput($output): array
    {
        return [
            ...
            'type'               => Str::contains($output['comment'], 'paying off loan') ? Subscription::TYPE_LOAN_PAYMENT : Subscription::TYPE_MEMBERSHIP,
